 ...
 * 
 * 점프문이란?
 * - 프로그램의 흐름을 특정 위치로 이동시키는 기능을 의미한다. (+ 즉, 점프문을 활용하면 
 ...
 * 
 * break 문이란?
 * - 프로그램의 흐름을 제어문 밖으로 이동시키는 기능을 의미한다. (+ 즉, break 문은 
 * 반복문과 switch ~ case 조건문 내부에서만 사용하는 것이 가능하다.)
 * 
 * continue 문이란?
 * - 프로그램의 현재 흐름을 생략하고 다음 흐름으로 이동시키는 기능을 의미한다.
		...
		public static void Start(string[] args)
		{
			...
			while(i < nNum)
			{
				...
				if(nVal % 2 == 0)
				{
					...
					/*
                     * continue 키워드는 프로그램의 현재 흐름을 생략하고 다음 흐름으로 이동시키는 
					 * 역할을 수행한다. 
                     * 
